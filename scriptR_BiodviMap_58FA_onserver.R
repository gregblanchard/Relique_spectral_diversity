...
load("/home/greg/projects/reliques/signature_spectrale_fragmentation/maps/biodivmapr/58FA_2021/RESULTS/T58KFA_raw_int_forest_zone_PDL/SPCA/PCA/Kmeans_Info.RData")
